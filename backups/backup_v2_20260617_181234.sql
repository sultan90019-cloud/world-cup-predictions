...
\restrict xsDrVC8wzQraem1Yq1UQYVWbt2kx2420EgRVgJFLwTrebpcaYvdCNCRUD2Zw7z8
...
ALTER TABLE IF EXISTS ONLY public.predictions DROP CONSTRAINT IF EXISTS predictions_match_id_fkey;
ALTER TABLE IF EXISTS ONLY public.matches DROP CONSTRAINT IF EXISTS matches_result_approved_by_fkey;
...
DROP INDEX IF EXISTS public.idx_matches_start_at;
...
ALTER TABLE IF EXISTS ONLY public.predictions DROP CONSTRAINT IF EXISTS predictions_user_id_match_id_key;
...
\unrestrict xsDrVC8wzQraem1Yq1UQYVWbt2kx2420EgRVgJFLwTrebpcaYvdCNCRUD2Zw7z8
